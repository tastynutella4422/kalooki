...
while (won == F) {
  ...
  if (p3.total.threes >= 3) {
    tack.on = T
  } else {
    tack.on = F
  }
  p3.gameplay = three.threes.gameplay(p3.hand,p3.total.threes,total.laid.down.cards,tack.on)
  ...
  if (p4.total.threes >= 3) {
    tack.on = T
  } else {
    tack.on = F
  }
  p4.gameplay = three.threes.gameplay(p4.hand,p4.total.threes,total.laid.down.cards,tack.on)
